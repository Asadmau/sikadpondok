        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Santri TPQ</h3>
                    ...
                    <form method="POST" action="{{route('siswa.store')}}" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            <div class="form-group {{ $errors->has('nisn') ? 'has-error' :'' }}">
                                ...
                                <input name="nisn" value="{{old('nisn')}}" type="number" class="form-control" placeholder="Masukkan NISN" maxlength="10" required>
                            ...
                            <div class="form-group {{ $errors->has('tgl_lahir') ? 'has-error' :'' }}">
                                ...
                                <input name="tgl_lahir" value="{{old('tgl_lahir')}}" type="date" class="form-control" placeholder="Masukkan Tanggal Lahir" maxlength="10" required>
                            ...
                            <div class="form-group {{ $errors->has('telepon') ? 'has-error' :'' }}">
                                ...
                                <input name="hp_wa" value="{{old('hp_wa')}}" type="text" class="form-control" placeholder="Masukkan Nomor HP/WA" maxlength="20">
                            ...
                            <div class="form-group {{ $errors->has('jenjang') ? 'has-error' :'' }}">
                                ...
                                <select name="jenjang" class="form-control" required>
                                    <option value="">-- Pilih --</option>
                                    <option value="Awwaliyah" {{(old('jenjang') == 'Awwaliyah') ? 'selected':''}}>Awwaliyah </option>
                                    <option value="Wustha" {{(old('jenjang') == 'Wustha') ? 'selected':''}}>Wustha </option>
                                    <option value="Ulya" {{(old('jenjang') == 'Ulya') ? 'selected':''}}>Ulya </option>
                                </select>
                            ...
                            <div class="row mt-2">
                                <div class="col-lg-4 col-xs-12">
                                    <img class="img-fluid" height="200" width="100" id="previewSantri" src="#" onerror="this.onerror=null;this.src='{{asset('img/foto.jpg')}}';">
                                </div>
                                <div class="col-lg-4 col-xs-12">
                                    <img class="img-fluid" height="200" width="100" id="previewWali" src="#" onerror="this.onerror=null;this.src='{{asset('img/foto.jpg')}}';">
                                </div>
                                <div class="col-lg-4 col-xs-12">
                                    <img class="img-fluid" height="200" width="100" id="previewWaliibu" src="#" onerror="this.onerror=null;this.src='{{asset('img/foto.jpg')}}';">
                                </div>
                            </div>
                            <div class="box-footer with-border mt-2">
                                <div class="btn-group">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}" />
                                    <button type="reset" class="btn btn-primary" onclick="return confirm('Yakin Data Akan di reset')">Kosongkan</button>
